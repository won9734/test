  ...
  <div class="site-section fund-raisers">
        ...
        <input type="hidden" value="${navi.currentPage }">
          ...
          <div class="dropdown" style="float: right;">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" href="chunglist.do?category=1">최신 게시물순</a>
              <!-- <a class="dropdown-item" href="chungnewest.do">오래된 게시물순</a> -->
              <a class="dropdown-item" href="chunglist.do?category=2">오래된 게시물순</a>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0">
                        <div class="card fundraise-item mb-5">
                            ...
                            <div class="card-body">
                              ...
                              <span class="fund-raised d-block">청원 마감일 : ${dto.pet_dead }</span>
                            </div>
                        </div>
                    </div>      
    ...
    <div style="width: 200px; margin: 0px auto;"> 
        <nav aria-label="Page navigation">
          <ul class="pagination">
            <li class="page-item">
              <a class="page-link" href="chunglist.do?page=1" aria-label="Previous">
                <span aria-hidden="true">&lt;&lt;</span>
              </a>
            </li>
            <li class="page-item">
            <a class="page-link" href="chunglist.do?page=${navi.startPageGroup-1 }&category=${category }&searchWord=${searchWord}">&lt;</a>
            </li>
        	...
        	<li class="page-item"><a class="page-link" href="chunglist.do?page=${counter }&category=${category }&searchWord=${searchWord}">${counter }</a></li>
        	</c:forEach>
        	<li class="page-item">
        		<a class="page-link" href="chunglist.do?page=${navi.endPageGroup+1 }&category=${category }&searchWord=${searchWord}">&gt;</a>
        	</li>
        	
            <li class="page-item">
              <a class="page-link" href="chunglist.do?page=${navi.totalRecordsCount}&category=${category }&searchWord=${searchWord}" aria-label="Next">
                <span aria-hidden="true">&gt;&gt;</span>
              </a>
            </li>
          </ul>
