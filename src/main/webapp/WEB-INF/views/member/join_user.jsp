      ...
      <div class="row block-9">
        <div class="col-md-6 pr-md-5" style="margin: 0 auto;">
          <form action="registUser.do" method="POST" enctype="multipart/form-data" id="usercheck">
            ...
            <div class="form-group joinbox">
              <input type="text" class="form-control px-3 py-3 join_input" placeholder="Name" style="width: 500px;" name="user_name" id="user_name">
              <div class="check_text" id="name_check"></div>
            </div>
            <div class="form-group joinbox">
              <input type="text" class="form-control px-3 py-3 join_input" placeholder="NickName" style="width: 500px;" name="user_nick" id="user_nick">
            ...
            <div class="form-group joinbox">
              <input type="text" class="form-control px-3 py-3 join_input" placeholder="Address" style="width: 400px;" name="user_addr" id="user_addr">
              <input type="button" value="주소 찾기" onClick="openDaumZipAddress();" class="form-control px-3 py-3 join_input" style="width: 96px; cursor: pointer; background-color: #999999 !important; color: #fff !important;" />
              <div class="check_text" id="addr_check"></div>
            </div>
            <div class="form-group joinbox">
              <input type="file" class="form-control px-3 py-3 join_input" placeholder="File" style="width: 500px; border: none; padding-left: 0px !important;" name="file" id="file">
            </div>
